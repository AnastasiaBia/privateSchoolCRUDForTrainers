...
<html>
    <head>
        <meta charset="UTF-8" />
        <title>Update Trainer-Trainer Management</title>
...
<!--        Update form which has the selected trainer data to be updated-->
        <div style="padding-top: 200px; text-align: center;" class="example">


            <p><b>Update Trainer</b></p>
            ...
            <form:form method="POST" action="/updatetrainer"
                ...
                <div style="padding: 2%;">
                    <span>
<!--                        Submit button which will perform the update - controller method /updatetrainer-->
                    ...
                    <span>
                        <!--                        Button which takes the user back to the list of trainers available for update -updatetrainers.jsp-->
                        <td><a href="/updatetrainers" class="w3-button w3-round-xlarge,
