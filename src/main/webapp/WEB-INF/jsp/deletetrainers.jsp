...
<html>
    ...
    <body>
        ...
        <!--    Table of trainers available for deletion-->
                ...
                <tbody>
                    <c:forEach items="${olatrainers}" var="tr">
                        <tr class="table-info">
                            ...
                            <!--            Link that acts as a button and brings the trainer id to the controller method /predelete-->
                            <td><a href="/predelete/${tr.trainerId}" class="w3-button w3-round-xlarge,
