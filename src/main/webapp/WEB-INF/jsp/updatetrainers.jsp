<%-- 
    ...
    Created on : Feb 23, 2020, 8:44:47 PM
    Author     : Natasa
--%>
...
<html>
    ...
    <body>
        ...
        <!--    Table of trainers available for update-->
                ...
                <tbody>
                    <c:forEach items="${olatrainers}" var="tr">
                        <tr class="table-info">
                            ...
                            <!--            Link that acts as a button and brings the trainer id to the controller method /preupdate-->

                            <td><a href="/preupdate/${tr.trainerId}" class="w3-button w3-round-xlarge,
